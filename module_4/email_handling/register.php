    ...
    <form method="post" id="frm1" action="mail.php">
        <div class="row">
            <div class="form-group mt-2 col-md-6">
                <input type="text" name="firstname" data-bvalidator="required,alpha"  placeholder="Firstname *" class="form-control">
            </div>
    
            <div class="form-group mt-2 col-md-6">
                <input type="text" name="lastname" data-bvalidator="required,alpha"  placeholder="Lastname *" class="form-control">
            </div>
        </div>
