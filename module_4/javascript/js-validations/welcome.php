...
<body>
    ...
    <section id="content">
        ...
        <h2 align="center" class="featured-hr"><span>Welcome to Our website</span></h2>        
        
        <div class="row">
            <div class="col-md-5 p-5  text-white">
                <h6>Welcome to our website</h6>
                <hr class="border border-1 w-50 border-white">
                <img src="https://media.tenor.com/D68fgAJz0tcAAAAM/ekrut-start-up.gif" class="img-fluid w-50">
            </div>
            <div class="col-md-7 p-5">
                <h6>Thanks for create your account </h6>
                <hr class="border border-1 w-50 border-dark">
     

                <img src="images/thank-you-icegif-7.gif">
